...
func (s *state) errorf(format string, args ...interface{}) {
	...
	s.errors = append(s.errors, ExecError{
		Name: s.tmpl.Name(),
...
func (s *state) evalCommand(dot reflect.Value, cmd *parse.CommandNode, final reflect.Value) reflect.Value {
	...
	case *parse.IdentifierNode:
		// Must be a function.
		return reflect.New(final.Type()) // s.evalFunction(dot, n, cmd, cmd.Args, final)
	case *parse.PipeNode:
...
func (s *state) evalArg(dot reflect.Value, typ reflect.Type, n parse.Node) reflect.Value {
	...
	case *parse.IdentifierNode:
		return reflect.New(typ) // s.validateType(s.evalFunction(dot, arg, arg, nil, missingVal), typ)
	case *parse.ChainNode:
...
func (s *state) evalEmptyInterface(dot reflect.Value, n parse.Node) reflect.Value {
	...
	case *parse.IdentifierNode:
		return reflect.New(missingVal.Type()) //.evalFunction(dot, n, n, nil, missingVal)
	case *parse.NilNode:
